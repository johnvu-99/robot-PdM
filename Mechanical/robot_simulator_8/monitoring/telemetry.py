...
CH_TEMPERATURE = CHANNEL_INDEX["temperature"]
...
class TelemetryRecorder(object):
    ...
    def record(self, timestamp, positions, targets, velocities, torques, reactions,
        ...
        row[:, CH_TEMPERATURE] = np.nan if temperatures is None else temperatures
        ...
        if self.monitor_enabled:
            self._monitor_pending.append(entry)
        return row
    ...
    def take_monitor_records(self):
        """Every sample since the last call, for the monitoring service."""
