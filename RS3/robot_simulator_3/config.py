...
# Labels written to every CSV row until fault injection (Phase 4) and the
# health model (Phase 5+) exist. Honest defaults, not estimates.
...
WINDOW_TITLE = "Industrial Robot Simulator - Phase 3"
